...
public class ArrayOfObjectsResultTest extends ResultTestTemplate {
    ...
    protected Object getExpectedValue() {
        final Map<String, Content> result = new HashMap<>();
        result.put("propertyA", Content.of(1.0));
        result.put("propertyB", Content.of("test value"));
        return result;
    }

    @Override
    protected String getGivenScript() {
        return "var test = {propertyA: 1, propertyB: 'test value'}; test";
    }
}

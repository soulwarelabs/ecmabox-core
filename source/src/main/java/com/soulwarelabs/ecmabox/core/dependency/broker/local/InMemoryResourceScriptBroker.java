...
@Private
@Immutable
public final class InMemoryResourceScriptBroker extends BaseResourceScriptBroker {
     ...
     */
    public InMemoryResourceScriptBroker(final ResourceScriptBroker failover) {
        super(failover);
    }

    @Override
    protected String receiveSpecific(final String resource) {
        // TODO: return script from in-memory storage
        throw new UnsupportedOperationException("In-memory resource scripts are not yet supported");
    }
}

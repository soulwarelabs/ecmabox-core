...
/**
 * Local storage-based broker implementation.
 *
...
@Private
@Immutable
public final class StorageResourceScriptBroker extends BaseResourceScriptBroker {
     ...
     */
    public StorageResourceScriptBroker(final ResourceScriptBroker failover) {
        super(failover);
    }

    @Override
    protected String receiveSpecific(final String resource) {
        // TODO: return script from a local storage
        throw new UnsupportedOperationException("Local-stored resource scripts are not yet supported");
    }
}

...
@Private
@Immutable
public final class NpmResourceScriptBroker extends NetworkResourceScriptBroker {
     ...
     * @see NetworkLayout
     */
    public NpmResourceScriptBroker(final ResourceScriptBroker failover,
    ...
    protected String receiveSpecific(final String resource) {
        // TODO: receive NPM resource script
        // TODO: use network properties
        throw new UnsupportedOperationException("NPM resource scripts are not yet supported");
    }
}

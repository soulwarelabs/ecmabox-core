...
@UnitTest(InMemoryResourceScriptBroker.class)
@RunWith(PowerMockRunner.class)
public class InMemoryResourceScriptBrokerTest {
    ...
    public void receiveScript() throws Exception {
        final InMemoryResourceScriptBroker broker = new InMemoryResourceScriptBroker(null);

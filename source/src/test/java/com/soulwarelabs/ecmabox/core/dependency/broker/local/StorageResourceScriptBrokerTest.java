...
@UnitTest(StorageResourceScriptBroker.class)
@RunWith(PowerMockRunner.class)
public class StorageResourceScriptBrokerTest {
    ...
    public void receiveScript() throws Exception {
        final StorageResourceScriptBroker broker = new StorageResourceScriptBroker(null);

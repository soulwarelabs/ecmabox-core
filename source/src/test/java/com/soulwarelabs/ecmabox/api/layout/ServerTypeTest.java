...
@UnitTest(ServerType.class)
@RunWith(PowerMockRunner.class)
public class ServerTypeTest {

    private List<ServerType> elements;

    @Before
    public void prepareElements() {
        elements = Collections.singletonList(ServerType.DEFAULT);
    }

    @Test
    public void doesNotContainExtraElements() throws Exception {
        Assert.assertEquals(elements.size(), ServerType.values().length);
    }
}
